...
- **Waitlist tracking** — PodPlay doesn't publish waitlist membership, so the app can't detect it; instead, a full session's card offers **"I'm waitlisted — track it"**. Tracked sessions show "◷" everywhere (calendar days show **✓ and ◷ side by side**, rows get the amber badge, "My sessions" includes them), the mark is stored on your device, and it clears itself automatically once the roster shows you got in.
