...
- Shows all listed, upcoming sessions in a **month grid** or **agenda list**.
- Filters by **type** (open play / clinic / social / special), **skill level** (L1–L5 + all-levels), **day of week**, and **start-time range**.
